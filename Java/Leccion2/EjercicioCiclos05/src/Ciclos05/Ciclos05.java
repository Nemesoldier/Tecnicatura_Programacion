...
para ellos generar un numero aleatorio entra 0-100 y luego
ir pidiendo numeros indicando "es mayor" o "es menor" segun sea mayor
o menor con respecto a N, el proceso termina cuando el usuario acierta y mostramos
el numero de intentos echos
*/
